...
| [代码 Review](./capabilities/execution/execution-review.md) | `/review` · `/code-review` · GitHub Review | `/review` · GitHub Review | `/review` 内置 Skill · `publish-assets` 证据图 · Web Shell 结构化结果 | 自然语言；无内置 `/review` | `/review [instruction]` |
